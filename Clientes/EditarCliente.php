...
<div class="container">
	...
	<article class=" col-xs-12 col-sm-8 col-md-9  col-lg-9">
		<p>
		<h1> Editor de datos del Cliente </h1>	
		<?php
 		require("../functions/funciones.php");
 		
		$ret= obtenerCliente($_GET['id']);
		...
		<table width="90%" height="182" border="0">
    <div class="form-group"> <tr>
      <td height="35"><label>ID:</label></td>
      <td><span class="form-group">
        <input type="text" value="<?php echo $ret['ID']; ?>">
      </span></td>
      <td>&nbsp;</td>
      </tr></div>
    <div class="form-group"><tr>
      <td height="35"><label>Nombre:</label></td>
      <td><span class="form-group">
        <input type="text" value="<?php echo $ret['NAME'];  ?>">
      </span></td>
      <td>&nbsp;</td>
      </tr></div>
    <div class="form-group"><tr>
      <td height="35"><label>Rut</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['TAXID']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
   <div class="form-group"> <tr>
      <td height="35"><label>Clave de Busqueda</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['SEARCHKEY']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
    <div class="form-group"><tr>
      <td height="35"><label>N° Tarjeta</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['CARD']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
    <div class="form-group"><tr>
      <td height="35"><label>Debito Max</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['MAXDEBT']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Dirección</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['ADDRESS']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Ciudad</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['CITY']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Email</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['EMAIL']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Celular</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['PHONE']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Notas</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['NOTES']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
      <div class="form-group"><tr>
      <td height="35"><label>Descuento</label></td>
      <td><span class="form-group"><input type="text" value="
      <?php  echo $ret['DISCOUNT']; ?>"></span></td>
      <td>&nbsp;</td>
      </tr></div>
